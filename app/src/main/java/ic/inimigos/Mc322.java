...
/**
 * Classe que herda de Inimigo {@link Inimigo} e cria uma espécie de inimigo mais específica, MC332
 */
public class Mc322 extends Inimigo {
    
    /**
     * Construtor da classe Mc322, um tipo de inimigo do jogo que herda de Inimigo {@link Inimigo}
    ...
    public void falaRodada1(Heroi heroi){
        ...
        System.out.println(Prints.MC322);
