...
/**
 * Classe que herda de Inimigo {@link Inimigo} e cria uma espécie de inimigo mais específica, MC404
 */
public class Mc404 extends Inimigo{
    
    /**
     * Construtor da classe Mc404, um tipo de inimigo do jogo que herda de Inimigo {@link Inimigo}
    ...
    public void falaRodada1(Heroi heroi){
        ...
        System.out.println(Prints.MC404);
        System.out.println(Cores.COLOR_RED + "\n- MC404: 'Agora nem preciso mais pegar leve com vocês. Se prepare " + heroi.getName() + ". Não vai ser facíl não, se prepare pra codar Assembly em papel" + Cores.COLOR_RESET);
    }
    ...
    public void imprimeAcaoInimigo(int acao){
        System.out.println("\n");
        if(acao == 0){
            System.out.println(Cores.COLOR_RED + "- MC404: 'Vou te fazer usar o gradle e você vai tomar 5 de dano ein, abre o olho'" + Cores.COLOR_RESET);
        }
        if(acao == 1){
            System.out.println(Cores.COLOR_RED + "- MC404: 'Vou te fazer tentar entender polimorfismo e encapsulamento ao mesmo tempo e te deixar com 4 pontos de burnout ein'" + Cores.COLOR_RESET);
        }
        if(acao == 2){
            System.out.println(Cores.COLOR_RED + "- MC404: 'Vou me deixar de Lock-In, com 3 pontos a mais de força, ein'" + Cores.COLOR_RESET);
        }
        if(acao == 3){
            System.out.println(Cores.COLOR_RED+  "- MC404: 'Vou me dar 3 de escudo, ein'" + Cores.COLOR_RESET);
        }
    }
    ...
    public void atacar(Entidade heroi, Combate combate, Tabuleiro tabuleiro){
        ...
        if(acao == 0){
            CartaDano ataque = new CartaDano("Instalar o gradle", "Você agora precisa utilizar o gradle, mas o GitHub ignora algumas pastas quando você vai dar pull e seu computador não aguenta rodar o gradle", 0, 5);
