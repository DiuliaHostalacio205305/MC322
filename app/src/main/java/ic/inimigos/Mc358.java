...
/**
 * Classe que herda de Inimigo {@link Inimigo} e cria uma espécie de inimigo mais específica, MC358
 */
public class Mc358 extends Inimigo{
    
    /**
     * Construtor da classe Mc358, um tipo de inimigo do jogo que herda de Inimigo {@link Inimigo}
    ...
    public void falaRodada1(Heroi heroi){
        ...
        System.out.println(Prints.MC358);
    ...
    public void imprimeAcaoInimigo(int acao){
        System.out.println("\n");
        if(acao == 0){
            System.out.println(Cores.COLOR_RED + "- MC358: 'Vou te fazer usar o gradle e você vai tomar 6 de dano ein, abre o olho'" + Cores.COLOR_RESET);
        }
        if(acao == 1){
            System.out.println(Cores.COLOR_RED + "- MC358: 'Vou te fazer tentar entender polimorfismo e encapsulamento ao mesmo tempo e te deixar com 4 pontos de burnout ein'" + Cores.COLOR_RESET);
        }
        if(acao == 2){
            System.out.println(Cores.COLOR_RED + "- MC358: 'Vou me deixar de Lock-In, com 3 pontos a mais de força, ein'" + Cores.COLOR_RESET);
        }
        if(acao == 3){
            System.out.println(Cores.COLOR_RED+  "- MC358: 'Vou me dar 3 de escudo, ein'" + Cores.COLOR_RESET);
        }
    }
