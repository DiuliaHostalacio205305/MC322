...
/**
 * Classe de testes unitários para o inimigo Mc322 
 ...
 */
public class Mc322Test {

    @Test
    public void testarAcoesMc322() {
        Heroi h = new Heroi("Heroi", 50, 0, 3, 3, 50);
        Mc322 inimigo = new Mc322("MC322", 50, 0, 50);
        ...
        assertEquals(6, 50 - h.getVida(), "Dano da ação 0 do MC322 está errado.");

        // Ação 1: 4 de burnout
        inimigo.setIntencao(1);
        inimigo.atacar(h, c, t);
        assertEquals(4, h.getBurnout(), "Burnout da ação 1 do MC322 está errado.");

        // Ação 2: 3 de LockIn
        inimigo.setIntencao(2);
        inimigo.atacar(h, c, t);
        assertEquals(3, inimigo.getLockin(), "Força da ação 2 do MC322 está errada.");

        // Ação 3: 3 de escudo
        inimigo.setIntencao(3);
        inimigo.atacar(h, c, t);
        assertEquals(3, inimigo.getEscudo(), "Escudo da ação 3 do MC322 está errado.");
    }
}